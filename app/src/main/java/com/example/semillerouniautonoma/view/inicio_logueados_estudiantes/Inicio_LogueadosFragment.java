...
import com.example.semillerouniautonoma.model.Adapters.listAdapterSeedbedsByuser;
 ...
 * Use the {@link Inicio_LogueadosFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Inicio_LogueadosFragment extends Fragment {
    CardView expand;
    LinearLayout layout;
    RecyclerView listseedbedsByuser,listmiembros_semillero;
    ...
    public Inicio_LogueadosFragment() {
     ...
     * @return A new instance of fragment Inicio_LogueadosFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Inicio_LogueadosFragment newInstance(String param1, String param2) {
        Inicio_LogueadosFragment fragment = new Inicio_LogueadosFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_inicio__logueados, container, false);
        View v2 = inflater.inflate(R.layout.listseedbedbyuser, container, false);
        ...
        listseedbedsByuser = v.findViewById(R.id.listSeedbedsbyUser);
                    ...
                    call2.enqueue(new Callback<List<SeedbedMembers>>() {
                        ...
                        public void onResponse(Call<List<SeedbedMembers>> call, Response<List<SeedbedMembers>> response) {
                              if (response.isSuccessful()) {
                                ...
                                listAdapterSeedbedsByuser listAdapter = new listAdapterSeedbedsByuser(seedbedsByuserList, getActivity(), correo, finalId_semillero);
                                listseedbedsByuser.setHasFixedSize(true);
                                listseedbedsByuser.setLayoutManager(new LinearLayoutManager(getActivity()));
                                listseedbedsByuser.setAdapter(listAdapter);
