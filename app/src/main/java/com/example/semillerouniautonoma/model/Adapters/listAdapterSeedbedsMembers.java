...
import com.example.semillerouniautonoma.view.inicio_logueados_estudiantes.contacto_implicitoFragment;
import com.example.semillerouniautonoma.view.inicio_logueados_estudiantes.contacto_miembros_Activity;

import java.util.List;

public class listAdapterSeedbedsMembers extends RecyclerView.Adapter<listAdapterSeedbedsMembers.childViewHolder> {
    private List<SeedbedMembers> mData;
    private LayoutInflater mInflater;
    private Context context;
    private String id_sem;

    public listAdapterSeedbedsMembers(List<SeedbedMembers> itemList, LayoutInflater mInflater, Context context, String id_sem) {
    ...
    @Override
    public listAdapterSeedbedsMembers.childViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listmembers,null);
        return new listAdapterSeedbedsMembers.childViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final listAdapterSeedbedsMembers.childViewHolder holder, final int position) {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.image_contacto_miembro:
                    Intent intent = new Intent(context, contacto_miembros_Activity.class);
