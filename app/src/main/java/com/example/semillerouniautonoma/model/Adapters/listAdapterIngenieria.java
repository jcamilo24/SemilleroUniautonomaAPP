...
public class listAdapterIngenieria extends RecyclerView.Adapter<listAdapterIngenieria.ViewHolder> {
    private List<seedbedFacultad> mData;
    private LayoutInflater mInflater;
    private Context context;

    public listAdapterIngenieria(List<seedbedFacultad> itemList, Context context) {
    ...
    @Override
    public listAdapterIngenieria.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listseedbeds, null);
        return new listAdapterIngenieria.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final listAdapterIngenieria.ViewHolder holder, final int position) {
